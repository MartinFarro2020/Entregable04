  ...
  return (
    <section className='p-0 m-0'>
      <header className='fixed w-full mb-[30px] p-0'>
        <nav className="flex justify-between mx-auto max-w-[980px] h-50 p-0 bg-white gap-4">
          <h2 className="flex font-bold  text-[#0F0F2D] text-4xl font-nunito-sans">Usuarios</h2> 
